// Generated on 2015-02-12 using generator-ionic 0.7.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.app %>/<%= yeoman.scripts %>/src/**/*.js'],
        tasks: ['concat:basic', 'newer:copy:app', 'newer:jshint:all']
      },
      styles: {
      ...
      gruntfile: {
        files: ['Gruntfile.js'],
        tasks: ['ngconstant:production', 'newer:copy:app']
      }
    },
    ...
    htmlmin: {
      dist: {
        ...
        files: [{
          expand: true,
          cwd: '<%= yeoman.dist %>',
          src: ['*.html', 'templates/**/*.html', '<%= yeoman.scripts %>/**/*.html'], //src: ['*.html', 'templates/**/*.html'],
          dest: '<%= yeoman.dist %>'
        }]
      }
    },
    ...
    copy: {
      dist: {
        files: [{
          ...
          src: ['generated/*']
        }, { // To add ionic fonts folder to build
          expand: true,
    ...
    //   options: {
    //     includeRuntime: true,
    //     traceurOptions: '--experimental' // '--experimental --source-maps'
    //   },
    //   'app': {
    //     files: {
    //       //'<%= yeoman.app %>/<%= yeoman.scripts %>/all.js': [ '<%= yeoman.app %>/<%= yeoman.scripts %>/src/sc.app.module.js', '<%= yeoman.app %>/<%= yeoman.scripts %>/src/constants.js', '<%= yeoman.app %>/<%= yeoman.scripts %>/src/*.js', '<%= yeoman.app %>/<%= yeoman.scripts %>/src/**/*.js' ]
    //       '<%= yeoman.app %>/<%= yeoman.scripts %>/all.js': [
    //         '<%= yeoman.app %>/<%= yeoman.scripts %>/src/*.module.js',
    //         '<%= yeoman.app %>/<%= yeoman.scripts %>/src/*.constants.js',
    //         '<%= yeoman.app %>/<%= yeoman.scripts %>/src/*.js',
    //         '<%= yeoman.app %>/<%= yeoman.scripts %>/src/**/*.app.js',
    //         '<%= yeoman.app %>/<%= yeoman.scripts %>/src/**/*.js'
    //         ]
    //     }
    //   }
    // },
    concat: { // instead of traceur, using concat:basic to copy files to all.js as it is.
      basic: {
        src: [
            '<%= yeoman.app %>/<%= yeoman.scripts %>/src/*.module.js',
            '<%= yeoman.app %>/<%= yeoman.scripts %>/src/*.constants.js',
        ...
        dest: '<%= yeoman.app %>/<%= yeoman.scripts %>/all.js',
      }
    },
  ...
  grunt.registerTask('ripple', ['concat:basic', 'wiredep', 'newer:copy:app', 'ripple-emulator']);
  ...
  grunt.registerTask('serve', function (target) {
    ...
    grunt.task.run(['concat:basic', 'wiredep', 'init', 'concurrent:ionic']);
  });
